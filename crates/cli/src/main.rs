...
fn cargo_toml(
    ...
    let core_dep = match framework_path {
        ...
        FrameworkPath::Git => r#"vanswarm-core = { git = "https://github.com/your-org/rust-agent-framework", branch = "main" }"#.to_string(),
    };
    let mut deps = format!(
        r#"[package]
name = "{}"
...
"#,
    ...
    if with_mcp {
        let mcp = match framework_path {
            ...
            FrameworkPath::Git => r#"vanswarm-mcp = { git = "https://github.com/your-org/rust-agent-framework", branch = "main" }"#,
        };
        deps.push_str("\n");
        deps.push_str(mcp);
        deps.push_str("\n");
    ...
    if with_memory {
        let mem = match framework_path {
            ...
            FrameworkPath::Git => r#"vanswarm-memory = { git = "https://github.com/your-org/rust-agent-framework", branch = "main" }"#,
        };
        deps.push_str("\n");
        deps.push_str(mem);
        deps.push_str("\n");
...
Agent project generated by [vanswarm new](https://github.com/your-org/rust-agent-framework).
