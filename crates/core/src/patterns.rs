...
///
/// ```rust,no_run
/// use rustmastra_core::patterns::{EvaluatorOptimizerLoop, EvalOptResult};
/// use rustmastra_core::evaluators::NonEmptyScorer;
///
/// async fn example() {
...
///
/// ```rust,no_run
/// use rustmastra_core::patterns::PlanAndExecute;
///
/// async fn example() {
