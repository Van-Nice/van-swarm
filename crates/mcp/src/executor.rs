//! MCP-backed `ToolExecutor` — use any MCP server's tools with a VanSwarm agent.
//!
...
use vanswarm_core::message::{ContentBlock, ToolDefinition, ToolExample};
...
impl McpToolExecutor {
    ...
    pub async fn refresh_tools(&self) -> vanswarm_core::Result<()> {
...
#[async_trait]
impl vanswarm_core::ToolExecutor for McpToolExecutor {
