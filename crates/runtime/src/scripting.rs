...
mod inner {
    ...
    use rustmastra_core::{FrameworkError, ToolExecutor};
    ...
    impl RhaiEngine {
        ...
        pub fn tool_definitions(&self) -> Vec<rustmastra_core::ToolDefinition> {
        ...
        engine.register_fn(
            ...
            move |tool_name: &str, args_json: &str| -> Result<rhai::Dynamic, Box<EvalAltResult>> {
                ...
                let text = match result {
                    rustmastra_core::ContentBlock::ToolResult { content, .. } => content,
                    rustmastra_core::ContentBlock::Text { text } => text,
                    other => format!("{other:?}"),
                };
    ...
    mod tests {
        ...
        use rustmastra_core::{ContentBlock, ToolDefinition};
