//! # rustmastra-mcp-server
//!
//! Stdio MCP server that exposes the RustMastra agent framework to any
...
//!
//! ```sh
//! ANTHROPIC_API_KEY=sk-ant-... cargo run -p rustmastra-mcp-server
//! ```
//!
...
//!   "mcpServers": {
//!     "rustmastra": {
//!       "command": "/path/to/rustmastra-mcp-server",
...
use rustmastra_core::providers::{AnthropicProvider, GeminiProvider, ModelProvider, OpenAiProvider};
...
async fn main() -> Result<()> {
    ...
    tracing_subscriber::fmt()
        .with_env_filter(
            tracing_subscriber::EnvFilter::from_default_env()
                .add_directive("rustmastra_mcp_server=info".parse()?)
    ...
    tracing::info!(
        ...
        "rustmastra-mcp-server starting"
    );
    ...
    tracing::info!("rustmastra-mcp-server ready");
