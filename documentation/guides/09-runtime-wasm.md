...
This guide covers **rustmastra-runtime**: the **Wasmtime**-based sandbox for running WASM modules as tools, and the optional **MCP bridge**.
...
The **rustmastra-runtime** crate may have optional features (e.g. **mcp-bridge**, **scripting** for Rhai). Check `crates/runtime/Cargo.toml` and enable what you need:

```toml
rustmastra-runtime = { path = "../runtime", features = ["wasm", "mcp-bridge"] }
```
