...
```rust
use rustmastra_core::tools::builtin::{ReadFileTool, TimeTool};
...
The **rustmastra-macros** crate provides **#[tool]** to derive the schema from your function signature and Rustdoc, and optionally add **examples** for the model.

Add dependency:

```toml
rustmastra-macros = { path = "../macros" }  # or your path
rustmastra-core = { path = "../core" }
```
...
```rust
use rustmastra_core::traits::tool::{FilteredToolExecutor, LocalToolRegistry};
