# Macros crate (vanswarm-macros)

Procedural macros for the VanSwarm framework: **`#[tool]`** and **`#[workflow]`**.
...
- Macros live in **vanswarm-macros** and depend on **vanswarm-core** for types referenced in error messages and validation (e.g. `DurableContext`).
